...
function HomeContent() {
  ...
  useEffect(() => {
    initializeStore().then(() => {
      ...
      // V4.0.7: DISABLED — dbSync overwrites live data with stale DB state,
      // causing intermittent data loss. Live data comes from /api/letras
      // via useLiveInstruments, which is already real-time.
      // startDbSync();
    ...
    return () => {
      ...
      // stopDbSync(); // V4.0.7: Disabled — no longer started
    };
  }, []);
      ...
      <header className="sticky top-0 z-30 header-gradient-bg backdrop-blur-xl">
        ...
        <div className="flex items-center justify-between px-5 py-2 border-b border-app-border/40">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[8px] text-app-text4 uppercase tracking-[0.2em] hidden sm:inline font-light">V4.0.9 — BLINDADO</span>
